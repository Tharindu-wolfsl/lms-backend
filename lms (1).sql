...
--
-- Table structure for table `grade09english`
--

CREATE TABLE `grade09english` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade09math`
--

CREATE TABLE `grade09math` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade09sci`
--

CREATE TABLE `grade09sci` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade09sinhala`
--

CREATE TABLE `grade09sinhala` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade10english`
--

CREATE TABLE `grade10english` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade10history`
--

CREATE TABLE `grade10history` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade10sinhala`
--

CREATE TABLE `grade10sinhala` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Dumping data for table `grade10sinhala`
--

INSERT INTO `grade10sinhala` (`id`, `date`, `medium`, `video1`, `week1`, `video2`, `week2`, `video3`, `week3`, `video4`, `week4`, `video5`, `week5`, `submit`) VALUES
(1, '2021-11-09', 'Sinhala', 'https://youtu.be/--PikweL_PU?list=PLHjwuoik-ep1Vb4RPXNUbAVHxB1rJRC8W', 'https://drive.google.com/file/d/1nbGD97wxjjFvkBWKo0j5H2fL-MmtHqc4/view?usp=sharing', 'https://youtu.be/aCjbDGkryec?list=PLHjwuoik-ep1Vb4RPXNUbAVHxB1rJRC8W', 'https://drive.google.com/file/d/1nbGD97wxjjFvkBWKo0j5H2fL-MmtHqc4/view?usp=sharing', 'https://youtu.be/MNS9X1fsngM?list=PLHjwuoik-ep1Vb4RPXNUbAVHxB1rJRC8W', 'https://drive.google.com/file/d/1nbGD97wxjjFvkBWKo0j5H2fL-MmtHqc4/view?usp=sharing', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `grade11english`
--

CREATE TABLE `grade11english` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade11history`
--

CREATE TABLE `grade11history` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Table structure for table `grade11sinhala`
--

CREATE TABLE `grade11sinhala` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `medium` varchar(30) NOT NULL,
  `video1` text NOT NULL,
...
--
-- Indexes for table `grade09english`
--
ALTER TABLE `grade09english`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `grade09math`
--
ALTER TABLE `grade09math`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `grade09sci`
--
ALTER TABLE `grade09sci`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `grade09sinhala`
--
ALTER TABLE `grade09sinhala`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `grade10english`
--
ALTER TABLE `grade10english`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `grade10history`
--
ALTER TABLE `grade10history`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `grade10sinhala`
--
ALTER TABLE `grade10sinhala`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `grade11english`
--
ALTER TABLE `grade11english`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `grade11history`
--
ALTER TABLE `grade11history`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `grade11sinhala`
--
ALTER TABLE `grade11sinhala`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `grade09english`
--
ALTER TABLE `grade09english`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grade09math`
--
ALTER TABLE `grade09math`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grade09sci`
--
ALTER TABLE `grade09sci`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grade09sinhala`
--
ALTER TABLE `grade09sinhala`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grade10english`
--
ALTER TABLE `grade10english`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grade10history`
--
ALTER TABLE `grade10history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `grade10sinhala`
--
ALTER TABLE `grade10sinhala`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `grade11english`
--
ALTER TABLE `grade11english`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grade11history`
--
ALTER TABLE `grade11history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `grade11sinhala`
--
ALTER TABLE `grade11sinhala`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
